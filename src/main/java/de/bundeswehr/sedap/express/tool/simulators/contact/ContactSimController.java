...
public class ContactSimController {
	...
	@FXML
	private ComboBox<?> commandStateComboBox;
	...
	@FXML
	void initialize() {
		assert altTextField != null : "fx:id=\"altTextField\" was not injected: check your FXML file 'OwnunitSimView.fxml'.";
		assert commandIDTextField != null : "fx:id=\"commandIDTextField\" was not injected: check your FXML file 'OwnunitSimView.fxml'.";
		assert commandStateComboBox != null : "fx:id=\"commandStateComboBox\" was not injected: check your FXML file 'OwnunitSimView.fxml'.";
		assert crsTextField != null : "fx:id=\"crsTextField\" was not injected: check your FXML file 'OwnunitSimView.fxml'.";
		assert hdgCrsCheckBox != null : "fx:id=\"hdgCrsCheckBox\" was not injected: check your FXML file 'OwnunitSimView.fxml'.";
		assert hdgTextField != null : "fx:id=\"hdgTextField\" was not injected: check your FXML file 'OwnunitSimView.fxml'.";
		assert latTextField != null : "fx:id=\"latTextField\" was not injected: check your FXML file 'OwnunitSimView.fxml'.";
		assert lonTextField != null : "fx:id=\"lonTextField\" was not injected: check your FXML file 'OwnunitSimView.fxml'.";
		assert nameTextField != null : "fx:id=\"nameTextField\" was not injected: check your FXML file 'OwnunitSimView.fxml'.";
		assert orbitToggleButton != null : "fx:id=\"orbitToggleButton\" was not injected: check your FXML file 'OwnunitSimView.fxml'.";
		assert presetComboBox != null : "fx:id=\"presetComboBox\" was not injected: check your FXML file 'OwnunitSimView.fxml'.";
		assert sidcTextField != null : "fx:id=\"sidcTextField\" was not injected: check your FXML file 'OwnunitSimView.fxml'.";
		assert simToggleButton != null : "fx:id=\"simToggleButton\" was not injected: check your FXML file 'OwnunitSimView.fxml'.";
		assert spdTextField != null : "fx:id=\"spdTextField\" was not injected: check your FXML file 'OwnunitSimView.fxml'.";
		assert spdUnitChooseBox != null : "fx:id=\"spdUnitChooseBox\" was not injected: check your FXML file 'OwnunitSimView.fxml'.";
		assert speedUnitLabel != null : "fx:id=\"speedUnitLabel\" was not injected: check your FXML file 'OwnunitSimView.fxml'.";
		assert staticToggleButton != null : "fx:id=\"staticToggleButton\" was not injected: check your FXML file 'OwnunitSimView.fxml'.";
		assert veloToggleGroup != null : "fx:id=\"veloToggleGroup\" was not injected: check your FXML file 'OwnunitSimView.fxml'.";
	...
	/**
	 * Aktiviert/Deaktiviert die Bearbeitbarkeit des Felder anhand des
	 * Simulationsstatus
	 *
	...
	/**
	 * Ändert den Inhalt der Textfelder zu den Daten aus der angegebenen OWNUNIT
	 * Nachricht.
	 *
